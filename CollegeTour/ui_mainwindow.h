...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout_5->addWidget(saddleQuantityLabel, 5, 1, 1, 1);
        ...
        saddlebackTab->setCurrentIndex(3);
