...
public:
    ...
    void setupUi(QDialog *login)
    {
        ...
        printNewUserLabel->setGeometry(QRect(290, 371, 361, 20));
        label->raise();
        UserNameInput->raise();
        PasswordInput->raise();
        userNameLabel->raise();
    ...
    void retranslateUi(QDialog *login)
    {
        ...
        printNewUserLabel->setText(QString());
    } // retranslateUi
